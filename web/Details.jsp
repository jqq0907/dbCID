			...
			window.onload = function() {
				...
				$.ajax({
					...
					success: function(msg) {
						...
						data=json_;
						console.log(json_);
						keys=['Disease','Chromosome','Gene','gDNA','cDNA','Protein','Type','Effect','Drug','HighestLevel','Evidence']
						for(keyid in keys)
						{
							...
							if(keys[keyid]=="Gene")
							{
								...
								$("."+keys[keyid])[1].innerHTML+="<a target='_blank'  href='"+href+"' style='cursor:pointer;color:#006699;'>"+json_[keys[keyid]]+"</a>";
								continue;
							}
							if(keys[keyid]=="Disease")
							{
								var href="http://www.disease-ontology.org/?id=DOID:"+json_["DOID"];
								$("."+keys[keyid])[1].innerHTML+="<a target='_blank'  href='"+href+"' style='cursor:pointer;color:#006699;'>"+json_[keys[keyid]]+" (DOID: "+json_["DOID"]+")"+"</a>";
								continue;
							}
